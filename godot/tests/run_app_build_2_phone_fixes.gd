...
func _run() -> void:
	...
	check(export_config.contains('application/short_version="1.2"'), "iOS export declares App Store marketing version 1.2")
	check(export_config.contains('application/version="13"'), "iOS export declares App Store build number 13")
