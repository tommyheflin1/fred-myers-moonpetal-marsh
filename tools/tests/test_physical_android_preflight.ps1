...
$ExpectedHash = "62E9BA3B105C264160D3F6810AB942A49AA666B75676D7BE9BD042FEC33A4D59"
...
try {
    $normalMetadata = '{"package":"com.flinsappvault.fredmyers.dev","version_code":20118,"version_name":"0.2.1-app-build-1-r18","min_sdk":24,"target_sdk":36,"abis":["arm64-v8a","x86_64"],"permission_count":0}'
    ...
    $wrongPackage = '{"package":"com.example.wrong","version_code":20118,"version_name":"0.2.1-app-build-1-r18","min_sdk":24,"target_sdk":36,"abis":["arm64-v8a","x86_64"],"permission_count":0}'
