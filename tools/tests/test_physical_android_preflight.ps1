...
$ExpectedHash = "63362ACC89B9EC4DA58CEA5F1D2CB6F836D720BFE5A98299BC8E0C0A1926420A"
...
try {
    $normalMetadata = '{"package":"com.flinsappvault.fredmyers.dev","version_code":20112,"version_name":"0.2.1-app-build-1-r12","min_sdk":24,"target_sdk":36,"abis":["arm64-v8a","x86_64"],"permission_count":0}'
    ...
    $wrongPackage = '{"package":"com.example.wrong","version_code":20112,"version_name":"0.2.1-app-build-1-r12","min_sdk":24,"target_sdk":36,"abis":["arm64-v8a","x86_64"],"permission_count":0}'
