...
$ExpectedHash = "2DA94078B21F2A9C0ADE46CADE02C89FDDA06E5742BF96C66AA84AAFC1C6B3C4"
...
try {
    $normalMetadata = '{"package":"com.flinsappvault.fredmyers.dev","version_code":20121,"version_name":"0.2.1-app-build-1-r21","min_sdk":24,"target_sdk":36,"abis":["arm64-v8a","x86_64"],"permission_count":0}'
    ...
    $wrongPackage = '{"package":"com.example.wrong","version_code":20121,"version_name":"0.2.1-app-build-1-r21","min_sdk":24,"target_sdk":36,"abis":["arm64-v8a","x86_64"],"permission_count":0}'
