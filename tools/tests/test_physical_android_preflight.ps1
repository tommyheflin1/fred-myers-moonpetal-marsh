...
$ExpectedHash = "ACCC754ACD7204FAA876D00C4D51B3BA3E4429B052A0E77CC9B568A9C4B1470F"
...
try {
    $normalMetadata = '{"package":"com.flinsappvault.fredmyers.dev","version_code":20110,"version_name":"0.2.1-app-build-1-r10","min_sdk":24,"target_sdk":36,"abis":["arm64-v8a","x86_64"],"permission_count":0}'
    ...
    $wrongPackage = '{"package":"com.example.wrong","version_code":20110,"version_name":"0.2.1-app-build-1-r10","min_sdk":24,"target_sdk":36,"abis":["arm64-v8a","x86_64"],"permission_count":0}'
